...
## Update local netbsd-scripts and netbsd-config repos
function cps {
    # scripts
    sudo chmod +x -R {$HOME,/root}/Shell/
    sudo rm -rf $HOME/GitHub/mine/scripts/netbsd-scripts/Shell && mkdir $HOME/GitHub/mine/scripts/netbsd-scripts/Shell
    sudo rm -rf $HOME/GitHub/mine/scripts/netbsd-scripts/root/Shell
    cp -a $HOME/Shell/* $HOME/GitHub/mine/scripts/netbsd-scripts/Shell
    cp -a $HOME/{.bashrc,.zshrc} $HOME/GitHub/mine/scripts/netbsd-scripts/
    sudo mkdir -p $HOME/GitHub/mine/scripts/netbsd-scripts/root
    sudo cp -a /root/{Shell,.bashrc,.zshrc} $HOME/GitHub/mine/scripts/netbsd-scripts/root
    sudo mkdir -p $HOME/GitHub/mine/scripts/netbsd-scripts/local/bin
}
